"""
Script for comapring the distribution shift and model error across different models trained on different data groups.
"""
...
models_results_paths = {
    "climsim_unet": "/home/users/bradlesc/projects/ClimSim/logs/p2.1.4/3/unet_from_npy_multiseed_2025-12-22-10-58-16",
    "vib_unet": "/home/users/bradlesc/projects/ClimSim/logs/p2.1.4/3/vib_unet_from_npy_multiseed_2025-12-22-10-58-42",
...
def main(cfg: DictConfig):
    ...
    models_results = {}
    for model_name, results_path in models_results_paths.items():

...
def main(cfg: DictConfig):
    ...
    # path_to_model = "/home/users/bradlesc/projects/ClimSim/logs/p2.1.4/9/testing/functional_test/2026-01-05-18-58-08/squeezeformer_group_MAM/squeezeformer_None_2026-01-05-18-58-08.ckpt"
    path_to_model = "/home/users/bradlesc/projects/ClimSim/logs/p2.1.4/9/testing/functional_test/2026-01-05-18-58-08/squeezeformer_group_SON/squeezeformer_None_2026-01-05-18-58-08.ckpt"
    ...
    model = models.load_model_from_checkpoint(
        path_to_model, cfg.model.name, cfg.model.single_run_configuration, cfg.dataset, normalisation_stats
    )
    model.to(device)
    ...
    model.eval()
    save_location = '/work/scratch-pw5/bradlesc/climsim/temp/p2.1.4.9_analysis/norm_outputs_001'
    model_name = 'train_group_SON'
    ...
    for key, loader in dataloaders.items():
        with torch.no_grad():
            ...
            np.save(os.path.join(save_location, f"{key}_latents.npy"), all_latents.numpy())

...
class Conv1DBlock(nn.Module):
    def __init__(
        self, embed_dim: int, out_dim: int, num_groups: int = 32, expand_ratio: int = 4
    ):
        """
        ...
        self.gn = nn.GroupNorm(num_groups=num_groups, num_channels=self.post_glu_dim)
...
class SqueezeFormer2(nn.Module):
    def __init__(
        self,
        in_dim: int,
        embed_dim: int,
